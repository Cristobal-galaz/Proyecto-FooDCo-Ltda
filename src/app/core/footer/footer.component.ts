...
export class FooterComponent {
  constructor(){
    ...
    iconRegistry.addSvgIconLiteral('facebook', sanitizer.bypassSecurityTrustHtml(svgFacebook));
    iconRegistry.addSvgIconLiteral('X', sanitizer.bypassSecurityTrustHtml(svgX));
    iconRegistry.addSvgIconLiteral('instagram', sanitizer.bypassSecurityTrustHtml(svgInstagram));
    iconRegistry.addSvgIconLiteral('email', sanitizer.bypassSecurityTrustHtml(svgCorreo));
    iconRegistry.addSvgIconLiteral('email', sanitizer.bypassSecurityTrustHtml(svgCorreo));
    iconRegistry.addSvgIconLiteral('flecha', sanitizer.bypassSecurityTrustHtml(svgFlecha));
  }
